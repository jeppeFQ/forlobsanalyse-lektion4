...
<div id="countdown-timer-6" data-duration="180" onclick="toggleTimer('countdown-timer-1')" style="font-size: 2em; color: #333; padding: 10px; cursor: pointer; display: inline-block;">
  02:00
</div>
